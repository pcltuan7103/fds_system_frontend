...
export const loginApiThunk = createAsyncThunk<
    ...
    ILoginEmail
>(AUTH_SIGN_IN_USER, async (payload, { rejectWithValue }) => {
    try {
...
export const registerApiThunk = createAsyncThunk<
    ResponseFromServer<TextResponse>,
    IRegisterEmail
>(AUTH_SIGN_UP_USER, async (payload, { rejectWithValue }) => {
    try {
...
export const requestOTPApiThunk = createAsyncThunk<
    ResponseFromServer<TextResponse>,
    string
>(REQUEST_OTP, async (email, { rejectWithValue }) => {
    try {
...
export const requestOtpForgetPasswordApiThunk = createAsyncThunk<
    ResponseFromServer<TextResponse>,
    string
>(REQUEST_OTP_FORGET_PASSWORD, async (email, { rejectWithValue }) => {
    try {
...
>(RESET_PASSWORD, async (payload, { rejectWithValue }) => {
    try {
