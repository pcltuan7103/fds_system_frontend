...
export const createPostApiThunk = createAsyncThunk<PostInfo, ActionParamPost>(
    CREATE_POST,
...
export const deletePostApiThunk = createAsyncThunk<
    ResponseFromServer<TextResponse>,
    string
>(DELETE_POST, async (payload, { rejectWithValue }) => {
    try {
