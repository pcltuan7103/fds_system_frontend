...
const AdminListCampaignStaffPage: FC = () => {
    ...
    const staffCampaigns = sortedCampaigns.filter(
        (campaign) => campaign.typeAccount === "Staff"
    );

    const rejectedCampaigns = staffCampaigns.filter(
        (campaign) => campaign.status === "Rejected"
    );

    const approvedCampaigns = staffCampaigns.filter(
        (campaign) => campaign.status === "Approved"
    );

    const pendingCampaigns = staffCampaigns.filter(
    ...
    const handleToDetail = (campaignId: string) => {
        const url = routes.admin.campaign.staff.detail.replace(
            ":id",
            campaignId
        );
        ...
        <section id="admin-list-campaign-staff" className="admin-section">
            ...
            <div className="admin-container alcs-container">
                <div className="alcscr1">
                    ...
                    <p>
                        Trang tổng quan
                        <span className="admin-tag">Nhân viên</span>
                    </p>
                </div>
                ...
                <div className="alcscr4">
                    <div className="alcscr4c1">
