...
const AdminListCampaignUserPage: FC = () => {
    ...
    const rejectedCampaigns = userCampaigns.filter(
        (campaign) => campaign.status === "Rejected"
    );

    const approvedCampaigns = userCampaigns.filter(
    ...
    const handleToDetail = (campaignId: string) => {
        const url = routes.admin.campaign.donor.detail.replace(
            ":id",
            campaignId
        );
    ...
    return (
        <section id="admin-list-campaign-donor" className="admin-section">
            ...
            <div className="admin-container alcd-container">
                ...
                <div className="alcdcr4">
                    <div className="alcdcr4c1">
