...
const AdminListCampaignPage: FC = () => {
    ...
    const rejectedCampaigns = sortedCampaigns.filter(campaign => campaign.status === "Rejected")

    const approvedCampaigns = sortedCampaigns.filter(campaign => campaign.status === "Approved")

    const pendingCampaigns = sortedCampaigns.filter(campaign => campaign.status === "Pending")
