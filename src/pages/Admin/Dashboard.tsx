            ...
            <div className="admin-container ad-container">
                <div className="adcr3">
                    <div className="adcr3-card adcr3-card-1">
                        ...
                        <p className='adcr3-card-quantity'>{approvedCampaigns.length}</p>
                    </div>
                    <div className="adcr3-card adcr3-card-2">
                        ...
                        <p className='adcr3-card-quantity'>{personalDonor.length}</p>
                    </div>
                    <div className="adcr3-card adcr3-card-3">
                        ...
                        <p className='adcr3-card-quantity'>{organizationDonor.length}</p>
                    </div>
                    <div className="adcr3-card adcr3-card-4">
                        ...
                        <p className='adcr3-card-quantity'>{recipients.length}</p>
                    </div>
                </div>
                <div className="adcr1">
