...
const UpdatePersonalDonorCertificateModal: FC<UpdatePersonalDonorCertificateModalProps> = ({ isOpen, setIsOpen, selectedCurrentPersonalDonorCertificate }) => {
    ...
    const initialValues: PersonalDonor = {
        ...
        otherImages: selectedCurrentPersonalDonorCertificate?.otherImages || [],
        citizenImages: selectedCurrentPersonalDonorCertificate?.citizenImages || [],
    };
    ...
    useEffect(() => {
        if (selectedCurrentPersonalDonorCertificate?.citizenImages?.length) {
            setImagePreview(selectedCurrentPersonalDonorCertificate.citizenImages);
        } else {
            setImagePreview([]);
        }
    ...
    useEffect(() => {
        if (selectedCurrentPersonalDonorCertificate?.otherImages?.length) {
            setOthersImagePreview(selectedCurrentPersonalDonorCertificate.otherImages);
        } else {
